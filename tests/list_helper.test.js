...
describe('favorite blog',() => {
  ...
  test('when multiple blogs have same max likes, return one of them', () => {
    const blogWithSameLikes = [
      {
        _id: 1,
        title: 'Blog A',
        author: 'Author A',
      ...
      },
      {
        ...
        likes: 10,  // Mismo número de likes
        __v: 0
      },
      {
        _id: "3",
    ...
    const result = listHelper.favoriteBlog(blogWithSameLikes)
